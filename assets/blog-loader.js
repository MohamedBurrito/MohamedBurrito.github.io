...
(function () {
  ...
  function renderCard(post) {
    ...
    const cover = meta.cover
      ? `<img src="${escapeHtml(meta.cover)}" alt="" style="width:100%;height:160px;object-fit:cover;border-radius:3px;margin-bottom:14px;border:1px solid var(--panel-line);">`
      : '';
    return `
    <div class="post post-clickable" data-href="${postUrl}" tabindex="0" role="link">
      ${cover}
